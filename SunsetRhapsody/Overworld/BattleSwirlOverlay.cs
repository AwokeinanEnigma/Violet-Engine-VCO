...
namespace SunsetRhapsody.Overworld
{
	internal class BattleSwirlOverlay : Renderable
	{
		...
		public BattleSwirlOverlay(BattleSwirlOverlay.Style style, int depth, float speed)
		{
			...
			this.shader = new Shader(EmbeddedResources.GetStream("SunsetRhapsody.Resources.bbg.vert"), EmbeddedResources.GetStream("SunsetRhapsody.Resources.gradmap.frag"));
