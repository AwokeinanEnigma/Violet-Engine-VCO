...
namespace SunsetRhapsody.SOMETHING
{
    public class Freeze : AUXBase
    {
        ...
        public override string QualifiedName => "PK Freeze";//{ get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        {
            PsiElementList animation = PsiAnimations.Get(1);
