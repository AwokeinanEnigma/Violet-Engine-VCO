...
namespace SunsetRhapsody.SOMETHING
{
    public class Freeze : AUXBase
    {
        ...
        public override string QualifiedName => "AUX Hurricane";//{ get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        {
            AUXElementList animation = AUXAnimations.Get(1);
