...
namespace SunsetRhapsody.Battle.Background
{
	internal class BattleBackground
	{
       ...
       //     Console.WriteLine("1");
		...
		{
			Shader shader = new Shader(EmbeddedResources.GetStream("SunsetRhapsody.Resources.bbg.vert"), EmbeddedResources.GetStream("SunsetRhapsody.Resources.bbg.frag"));
