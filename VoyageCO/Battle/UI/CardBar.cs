...
namespace VCO.Battle.UI
{
    internal class CardBar : Actor
    {
        ...
        public CardBar(RenderPipeline pipeline, CharacterType[] party, BattleInterfaceController controller)
        {
            ...
            {
                Vector2f position = ViewManager.Instance.FinalTopLeft + new Vector2f(this.leftMargin + 63 * i, idleY);
        ...
        {
            this.cards[index].SetTargetY(this.idleY - height);
        }
