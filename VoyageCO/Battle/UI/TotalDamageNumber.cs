...
namespace VCO.Battle.UI
{
    internal class TotalDamageNumber : IDisposable
    {
        ...
        public void Reset(Vector2f position, int number)
        {
            ...
            {
                this.numbers[k].Position = this.position - new Vector2f(num4, num5);
        ...
        private void UpdatePosition()
        {
            ...
            for (int i = 0; i < this.numbers.Length; i++)
            {
                this.numbers[i].Position = new Vector2f((int)(this.numbers[i].Position.X + this.translation.X), (int)(this.numbers[i].Position.Y + this.translation.Y));
            }
        }
