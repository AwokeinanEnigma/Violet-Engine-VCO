    ...
    internal class ButtonBar : Actor
    {
        ...
        private void SetUpButtons(ButtonBar.Action[] newActions)
        {
            ...
            for (int k = 0; k < this.buttons.Length; k++)
            {
                ...
                this.buttons[k].Position = new Vector2f(num2, this.buttonYs[k]);
        ...
        public override void Update()
        {
            ...
            for (int i = 0; i < this.buttons.Length; i++)
            {
                ...
                {
                    this.buttonYs[i] += (int)((this.buttonHeights[i] - this.buttonYs[i]) / 2f);
                    this.buttons[i].Position = new Vector2f(this.buttons[i].Position.X, this.buttonYs[i]);
                }
