...
namespace VCO.Scenes
{
    internal class NamingScene : StandardScene
    {
        ...
        private void CreateBackgroundVerts()
        {
            ...
            while (num3 < 180L)
            {
                ...
                while (num4 < 320L)
                {
                    ...
                    this.backVerts[num++] = new Vertex(new Vector2f(num4, num3), color);
                    this.backVerts[num++] = new Vertex(new Vector2f(num4 + 10, num3), color);
                    this.backVerts[num++] = new Vertex(new Vector2f(num4 + 10, num3 + 10), color);
                    this.backVerts[num++] = new Vertex(new Vector2f(num4, num3 + 10), color);
                    num2++;
                    num4 += 10;
                }
                if (flag)
        ...
        {
            base.Focus();
            AudioManager.Instance.SetBGM(DataHandler.instance.Load("hint.mp3"));
        ...
        {
            this.dontCareNames.TryGetValue(NamingScene.CHARACTER_ORDER[this.characterIndex], out List<string> list);
