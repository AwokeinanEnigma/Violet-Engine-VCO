...
namespace VCO.Scenes.Transitions
{
    internal class BattleFadeTransition : ITransition
    {
        ...
        public void Update()
        {
            ...
            {
                b = (byte)(255.0 * (Math.Cos(this.progress * 3f * 3.141592653589793 + 3.141592653589793) / 4.0 + 0.25));
            }
            ...
            {
                b = (byte)(255.0 * (Math.Cos((this.progress - 0.666f) * 3f * 3.141592653589793 + 3.141592653589793) / 4.0 + 0.75));
            }
            else
            {
            ...
            else
            {
                ...
                b2 = (byte)(color.R * num2);
                b3 = (byte)(color.G * num2);
                b4 = (byte)(color.B * num2);
                b2 /= 12;
                b2 *= 12;
                b3 /= 12;
                b3 *= 12;
