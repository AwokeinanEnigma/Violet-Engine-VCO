...
namespace VCO.Scenes
{
    internal class BattleScene : StandardScene
    {
        ...
        private void GenerateDebugVerts()
        {
            ...
            {
                int num = (int)(160L + (int)(comboNode.Timestamp * 0.1f));
                int num2 = 90;
                if (comboNode.Type == ComboType.Point)
                {
                    this.debugBeatVerts.Append(new Vertex(new Vector2f(num, num2 - 4), Color.Cyan));
                    this.debugBeatVerts.Append(new Vertex(new Vector2f(num, num2 + 4), Color.Cyan));
                }
                else if (comboNode.Type == ComboType.BPMRange)
                {
                    ...
                    {
                        int num4 = num + (int)(num3 * 0.1f);
                        this.debugBeatVerts.Append(new Vertex(new Vector2f(num4, num2 - 4), Color.Cyan));
                        this.debugBeatVerts.Append(new Vertex(new Vector2f(num4, num2 + 4), Color.Cyan));
                    }
                }
            }
