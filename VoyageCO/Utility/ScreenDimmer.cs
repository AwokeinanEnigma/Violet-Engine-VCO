...
namespace VCO.Utility
{
    internal class ScreenDimmer : IDisposable
    {
        ...
        public ScreenDimmer(RenderPipeline pipeline, Color color, int duration, int depth)
        {
            ...
            this.shape = new ShapeGraphic(this.rect, ViewManager.Instance.FinalCenter, new Vector2f((int)(this.rect.Size.X / 2f), (int)(this.rect.Size.Y / 2f)), this.rect.Size, depth);
