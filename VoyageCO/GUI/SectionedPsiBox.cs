...
namespace VCO.GUI
{
    ...
    internal class SectionedAUXBox : Actor
    {
        ...
        {
            this.AUXTypes.Add(new TextRegion(new Vector2f(this.windowPosition.X + 12f, this.windowPosition.Y + 5f + this.lineHeight * AUXTypes.Count), 32768, Fonts.Main, name));
        }
                ...
                if (AUX.aux.Symbols[0] <= this.MaxLevel)
                {
                    ...
                    else
                    {
                        ...
                        if (AUX.aux.Symbols.Length == 4)
                        {
                            ...
                            {
                                this.activeBetaList.Add(new TextRegion(new Vector2f(220f, this.windowPosition.Y + 5f + this.lineHeight * (this.activeAUXList.Count - this.firstVisibleIndex)), 32768, Fonts.Main, "β"));
                                if (AUX.aux.Symbols[2] < this.MaxLevel)
                                {
                                    this.activeGammaList.Add(new TextRegion(new Vector2f(240f, this.windowPosition.Y + 5f + this.lineHeight * (this.activeAUXList.Count - this.firstVisibleIndex)), 32768, Fonts.Main, "γ"));
                                    if (AUX.aux.Symbols[3] < this.MaxLevel)
                                    {
                                        this.activeOmegaList.Add(new TextRegion(new Vector2f(260f, this.windowPosition.Y + 5f + this.lineHeight * (this.activeAUXList.Count - this.firstVisibleIndex)), 32768, Fonts.Main, "Ω"));
                                    }
                                    else
                                    {
                                        this.activeOmegaList.Add(null);
                        ...
                        else if (AUX.aux.Symbols.Length == 2)
                        {
                            if (AUX.aux.Symbols[1] < this.MaxLevel)
                            {
                                this.activeOmegaList.Add(new TextRegion(new Vector2f(220f, this.windowPosition.Y + 5f + this.lineHeight * (this.activeAUXList.Count - this.firstVisibleIndex)), 32768, Fonts.Main, "Ω"));
                            }
                            else
                            {
                                this.activeOmegaList.Add(null);
                        ...
                        this.activeAUXList.Add(new TextRegion(new Vector2f(120f, this.windowPosition.Y + 5f + this.lineHeight * (this.activeAUXList.Count - this.firstVisibleIndex)), 32768, Fonts.Main, AUX.aux.QualifiedName));
                    }
                }
            }
        }
