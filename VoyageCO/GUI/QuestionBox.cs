...
namespace VCO.GUI
{
    internal class QuestionBox : TextBox
    {
        ...
        protected override void Recenter()
        {
            ...
            Vector2f v2 = new Vector2f(0f, 14 * this.optionsLineOffset);
            ...
            this.arrowYpos[0] = this.option1.Position.Y + Fonts.Main.WHeight - this.selectionArrow.Size.Y / 2f;
            this.arrowYpos[1] = this.option2.Position.Y + Fonts.Main.WHeight - this.selectionArrow.Size.Y / 2f;
