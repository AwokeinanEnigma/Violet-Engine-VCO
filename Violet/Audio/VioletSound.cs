...
{
    public abstract class VioletSound : IDisposable
    {
        ...
        public event VioletSound.OnCompleteHandler OnComplete;

        public VioletSound(AudioType soundType, uint loopBegin, uint loopEnd, int loopCount, float volume, float pitch)
        {
        ...
        public delegate void OnCompleteHandler(VioletSound sender);
    }
}
